...
SUDO = SUDO
sudo_users = {SUDO,839224120,1890819157}   
print([[
  _                               
 | |                              
...
io.popen("cd library && wget https://raw.githubusercontent.com/lacasaa/lacasa/master/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/lacassasource/Files_lacasa/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevlacasaW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevlacasaW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevlacasaW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevlacasaW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevlacasaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevlacasaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevlacasaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(839224120) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
local UserName = (data.username_ or "lacassasource")
...
local lacasa_Msg = ''  
if msgs < 100 then 
lacasa_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
lacasa_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
lacasa_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
lacasa_Msg = 'متفاعل' 
elseif msgs < 1200 then 
lacasa_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
lacasa_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
lacasa_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
lacasa_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
lacasa_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
lacasa_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
lacasa_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
lacasa_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
lacasa_Msg = 'رب التفاعل'  
end 
return lacasa_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@el_pro_f")  
...
--------------------------------------------------------------------------------------------------------------
function Sourcelacasa(msg,data) -- بداية العمل سـونـيك الـ دلـيـم
if msg then
...
if not DevlacasaW(msg) then
if text == '/start' then 
Namebot = (database:get(bot_id.."Name:Bot") or "لاكسا")
...
local Text = 'اهلا بك في العاب سورس لاكسا\nاختار اللعبه من القائمه'
local keyboard = {
{'صراحه','تويت'},
{'الابراج','حساب العمر'},
...
--------
if text == '『 البروفيسور 』𓄁︎' then 
local Text = [[ 
『 البروفيسور 』𓄁︎
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '『 𝒂.𝒘𝒆𝒌𝒂 』𓄁︎', url="t.me/el_pro_f"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙇𝘼𝘾𝘼𝙎𝙎𝘼', url="t.me/lacassasource"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local list = database:smembers(bot_id.."lacasa1:List:Filter"..sl)
...
if not DevlacasaW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevlacasaW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,lacasa_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ❈' and DevlacasaW(msg) then  
...
if text == 'تعطيل التواصل ❈' and DevlacasaW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❈' and DevlacasaW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❈' and DevlacasaW(msg) then  
...
if text == 'ضع كليشه ستارت ❈' and DevlacasaW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *❈︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ❈' and DevlacasaW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *❈︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ❈' and DevlacasaW(msg) then 
...
if text == 'تحديث السورس ❈' and DevlacasaW(msg) then 
os.execute('rm -rf lacasa.lua')
os.execute('wget https://raw.githubusercontent.com/lacasaa/lacasa/master/lacasa.lua')
send(msg.chat_id_, msg.id_,' *❈︙تم تحديث السورس* \n*❈︙لديك اخر اصدار لسورس لاكسا*\n*❈︙الاصدار » { 1V}*')
dofile('lacasa.lua')  
end
if text == 'الاصدار ❈' and DevlacasaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *❈︙اصدار سورس لاكسا* \n*❈︙الاصدار »{ 1v}*')
end
if text == 'قناه تحديثات البوت ❈' and DevlacasaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈︙[تحديثات البوت](t.me/lacassasource) \n❈︙[قناه السورس](t.me/lacassasource)')
end
if text == "ضع اسم للبوت ❈" and DevlacasaW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ❈' and DevlacasaW(msg) then 
...
if text == 'المشتركين ❈' and DevlacasaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❈︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ❈' and DevlacasaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❈︙الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❈") and DevlacasaW(msg) then
...
if text == ("قائمه العام ❈") and DevlacasaW(msg) then
...
if text == ("قائمه الكتم العام ❈") and DevlacasaW(msg) then
...
if text=="اذاعه خاص ❈" and msg.reply_to_message_id_ == 0 and DevlacasaW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل الان اذاعتك؟* \n*❈︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ❈" and msg.reply_to_message_id_ == 0 and DevlacasaW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل الان اذاعتك؟* \n*❈︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ❈" and msg.reply_to_message_id_ == 0 and DevlacasaW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل الان اذاعتك؟* \n*❈︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ❈" and msg.reply_to_message_id_ == 0  and DevlacasaW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ❈" and msg.reply_to_message_id_ == 0  and DevlacasaW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❈' and DevlacasaW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❈" and DevlacasaW(msg) then
...
if text == "تنظيف الجروبات ❈" and DevlacasaW(msg) then 
...
send(msg.chat_id_, msg.id_,'*❈︙عدد الجروبات الان » { '..#group..' }'..lacasak..''..lacasa..'*\n*❈︙الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevlacasaW(msg) then
...
usertext = '*\n ❈︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'lacassasource')..')'
status  = '\n *❈︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevlacasaW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *❈︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
status  = '\n*❈︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevlacasaW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevlacasaW(msg) then
...
local lacasa1_Msg = database:get(bot_id.."lacasa1:Add:Filter:Rp2"..text..msg.chat_id_)   
if lacasa1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❈︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lacassasource')..') \n ❈︙'..lacasa1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://lacassasource.ml/amir00/captcha.php?c='..captcha..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end 
--------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------
if lacasa_Msg and not Special(msg) then  
local lacasa_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if lacasa_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❈︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❈︙["..lacasa_Msg.."] \n")
else
send(msg.chat_id_,0," *❈︙العضو :* {["..data.first_name_.."](T.ME/lacassasource)}\n❈︙["..lacasa_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
Text = "ᯓتم طرد البوت من مجموعه  \nᯓمعرف العضو ⌯» @"..(result.username_ or "لا يوجد").."\nᯓايدي العضو ⌯» `"..msg.sender_user_id_.."`\nᯓمعلومات المجموعه ،  \n\nᯓاسم المجموعه ⌯»  *"..f2.title_.."*\nᯓايدي المجموعه ⌯» `"..msg.chat_id_.."`\nᯓرابط المجموعه ["..LinkGp.."] \nᯓتم مسح جميع بياناتها\n"
...
local msg_id = msg.id_/2097152/0.5
local res = https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/lacassasource/7876&caption=' .. URL.escape(Texti).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0, " *❈︙عذرا ↫* {["..data.first_name_.."](T.ME/lacassasource)}\n*❈︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevlacasaW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevlacasaW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevlacasaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevlacasaW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ❈" and DevlacasaW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *❈︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❈$") and DevlacasaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❈" and DevlacasaW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ❈" and DevlacasaW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *❈︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ❈" and DevlacasaW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."lacasa:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."lacasa:blocname"..msg.chat_id_)
...
function lacassasource_name(t1,t2)
if t2.id_ then 
name_lacasa = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_lacasa then 
names_lacasa = database:smembers(bot_id.."lacasa:blocname"..msg.chat_id_) or ""
if names_lacasa and names_lacasa[1] then 
for i=1,#names_lacasa do 
if name_lacasa:match("(.*)("..names_lacasa[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, lacassasource_name)
end
...
database:set(bot_id.."lacasa:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."lacasa:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."lacasa:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."lacasa:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."lacasa:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_lacasaa_new(lacasa1,lacasa2)
if lacasa2 and lacasa2.first_name_ then 
if lacasa2.first_name_:match("(.*)"..database:get(bot_id.."lacasa:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."lacasa:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local lacasa_nnn = database:get(bot_id.."lacasa:nump"..msg.chat_id_) or 5
local lacasa_nnn2 = database:get(bot_id.."lacasa:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(lacasa_nnn2) == tonumber(lacasa_nnn) or tonumber(lacasa_nnn2) > tonumber(lacasa_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."lacasa:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❈︙ عزيزي >>["..lacasa2.username_.."](https://t.me/"..(lacasa2.username_ or "lacassasource")..")\n❈︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."lacasa:teh"..msg.chat_id_).."} بجانب اسمك\n❈︙ عدد المحاولات المتبقيه {"..(tonumber(lacasa_nnn) - tonumber(lacasa_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_lacasaa_new)
end
end
...
local lacasaChengName = database:get(bot_id.."lacasa:Cheng:Name"..data.id_)
if not data.first_name_ then 
if lacasaChengName then 
send(msg.chat_id_, msg.id_, " مش كان اسمك ["..lacasaChengName..']')
database:del(bot_id.."lacasa:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if lacasaChengName ~= data.first_name_ then 
local Text = {
  "اسمك الاول كان احلي",
"الحلو دا غير اسمو",
}
...
database:set(bot_id.."lacasa:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local lacasaChengUserName = database:get(bot_id.."lacasa:Cheng:UserName"..data.id_)
if not data.username_ then 
if lacasaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..lacasaChengUserName..']')
database:del(bot_id.."lacasa:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if lacasaChengUserName ~= data.username_ then 
local Text = {
'القمر دة غير معرفو',
"غيرت معرفك لي يقمرر",
...
database:set(bot_id.."lacasa:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local lacasaChengPhoto = database:get(bot_id.."lacasa:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if lacasaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلوه دا 😂😂")
database:del(bot_id.."lacasa:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if lacasaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  " غيرت صورتك يقمر 😂 ",
...
database:set(bot_id.."lacasa:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' and GetSourseMember(msg) then
local Text =[[
° 𝙇𝘼𝘾𝘼𝙎𝙎𝘼 𝙎𝙊𝙐𝙍𝘾𝙀 °
]]
keyboard = {} 
...
{
{text = 'ѕᴏᴜʀᴄᴇ', url = "https://t.me/lacassasource"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/uu_lv/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevlacasaW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*❈︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lacassasource')..') \n*❈︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❈︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'lacassasource')..') \n*❈︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ سـونـيك 
if text == 'تحديث' and DevlacasaW(msg) then
dofile('lacasa.lua')  
send(msg.chat_id_, msg.id_, ' *❈︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevlacasaW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevlacasaW(msg) then  
function start_function(extra, result, success)
if lacasaSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevlacasaW(msg) then  
...
if lacasaSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevlacasaW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if lacasaSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevlacasaW(msg) then  
function start_function(extra, result, success)
if lacasaSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevlacasaW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevlacasaW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if lacasaSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevlacasaW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevlacasaW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevlacasaW(msg) then  
...
------------------------------------------------------------------------ سـونـيك 
if text == ("مسح المطورين") and DevlacasaW(msg) then
...
if database:get(bot_id.."lacassasource:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'lacassasource:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevlacasaW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevlacasaW(msg) then  
function start_function(extra, result, success)
...
st = https.request('https://lacassasource.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
if eker.ok.Info == "Indecent" then
local list = database:smembers(bot_id.."Basic:Constructor"..msg.chat_id_)
t = "*❈︙المنشئين الاساسين تعالو الروم باظظ *•━━━━━━ ━━━━━━━•* \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
local UserName = (b.username_ or "lacassasource")
...
function Function_lacasa(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_lacasa, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_lacasa, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❈︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
status  = '\n*❈︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *❈︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
status  = '\n*❈︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *❈︙اسم المستخدم »* '..userid..''
...
local  statuss  = '\n❈︙تم رفع العضو خول الجروب \n❈︙بطل منيكه هنا بقا دا روم رجاله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
status  = '\n❈︙تم تنزيل العضو خول من الجروب\n❈︙روح خد كورسات رجوله بقا'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
status  = '\n❈︙تم تنزيل العضوه من قائمه وتكات الجروب\n❈︙كفايه مكياج يا سيد '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n❈︙تم رفع العضــو معرص الجروب \n❈︙مش اي راجل بيبقا راجل يعرص'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
status  = '\n❈︙تم تنزيله من معرصين الجروب\n❈︙مبروك علي كورسات الرجوله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, '❈︙تم تنزيل كلاب الجروب')
end
...
send(msg.chat_id_, msg.id_, '❈︙تم تنزيل جميع الحمير')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
local  statuss  = '\n❈︙تم رفع المتناك في الجروب\n❈︙متيجي انيكك واكسب الثواب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, '❈︙تم تنزيل جميع المتوحدين')
end
...
send(msg.chat_id_, msg.id_, '❈︙تم تنزيل جميع الحكاكين')
end
...
tdcli_function ({ID = "GetUser",user_id_ = 839224120,},function(arg,result) 
local function mahmoud(extra, mahmoud, success)
if mahmoud.photos_[0] then
local Name = ' 𝙇𝘼𝘾𝘼𝙎𝙎𝘼 𝙎𝙊𝙐𝙍𝘾𝙀  ⸙\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 839224120, offset_ = 0, limit_ = 1 }, mahmoud, nil)
end,nil)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = 1890819157,},function(arg,result) 
local function mahmoud(extra, mahmoud, success)
if mahmoud.photos_[0] then
local Name = '\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1890819157, offset_ = 0, limit_ = 1 }, mahmoud, nil)
end,nil)
end
end
...
database:set(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *❈︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."lacasa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."lacasa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *❈︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."lacasa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."lacasa1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."lacasa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *❈︙ارسل الكلمه الان*")  
database:set(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."lacasa1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."lacasa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."lacasa1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."lacasa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."lacasa1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."lacasa1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevlacasaW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *❈︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevlacasaW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *❈︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'lacassasource')..')'..'\n*❈︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevlacasaW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevlacasaW(msg) then  
...
if not database:get(bot_id..'lacassasource:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'lacassasource:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'لاكسا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'لاكسا')
local lacasa_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
...
send(msg.chat_id_, msg.id_,'['..lacasa_Msg[math.random(#lacasa_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevlacasaW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,lacasa)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ ━━━━━━━•*\n"
x = 0
local list = lacasa.members_
for k, v in pairs(list) do
x = x + 1
...
if lacasaSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevlacasaW(msg) then 
...
if text == ("ردود المطور") and DevlacasaW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❈︙قائمة ردود المطور \n*•━━━━━━ ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevlacasaW(msg) then    
send(msg.chat_id_, msg.id_,' *❈︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'مسح رد عام' and DevlacasaW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'لاكسا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevlacasaW(msg) then   
...
if text == 'تعطيل المغادره' and DevlacasaW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'lacassasource')..')'
local iduser = result.sender_user_id_
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,'❈︙ايديك ↫ '..msg.sender_user_id_..'\n❈︙معرفك ↫ '..username..'\n❈︙رتبتك ↫ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n❈︙موقعك ↫ '..rtpa..'\n❈︙تفاعلك ↫ '..Total_Msg(Msguser)..'\n❈︙رسائلك ↫ '..Msguser..'\n❈︙البايو ↫ '..getbioY..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
...
if text =='جلب المشتركين' and DevlacasaW(msg) then
local list = database:smembers(bot_id..'User_Bot')  
local t = '{"users":['  
for k,v in pairs(list) do
if k == 1 then
...
if text =='رفع المشتركين' and DevlacasaW(msg) then
function by_reply(extra, result, success)   
if result.content_.document_ then 
local ID_FILE = result.content_.document_.document_.persistent_id_ 
local File_Name = result.content_.document_.file_name_
...
-- vardump(data) 
lacasadx(msg.chat_id_, msg.id_, ' *❈︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*❈︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*❈︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*❈︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
zh = https.request('https://lacasa-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*❈︙قائمه الزخرفه* \nٴ❈∫ٴ*•━━━━━━ ━━━━━━━•*ٴ❈∫○ٴ \n"
i = 0
...
data,res = https.request('https://lacasa-api.ml/audios.php')
if res == 200 then
 ...
 *❈~⪼لعبه المعاني ↞ العبه الشهيره* 
  *❈~⪼لعبه كت تويت ↞ لعبه اسئله* 
    *❈~لعبه  صراحه ↞ لعبه اسئله* 
*ٴ•━━━━━━ ━━━━━━━•*
[- قـناة الـسورس](t.me/lacassasource)
]]
...
if database:get(bot_id.."lacassasource:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"*انتظر دقيقه من فضلك*")
end
database:setex(bot_id..'lacassasource:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '- Source lacasa .', url="t.me/lacassasource"}},}
...
{{text = '- Source lacasa .', url="t.me/lacassasource"}},
}
...
inline = {
{{text = '𝙇𝘼𝘾𝘼𝙎𝙎𝘼 𝙎𝙊𝙐𝙍𝘾𝙀',url='http://t.me/lacassasource'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'لاكسا')
...
lacasa = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(lacasa)
...
--------------------------------------------------------------------------------------------------------------
Sourcelacasa(data.message_,data)
...
------------------------------------------------------------------------
local u660p = database:get(bot_id.."lacasa1:Add:Filter:Rp2"..text..result.chat_id_)   
if u660p then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❈︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❈︙["..u660p.."] \n") 
...
------------------------------------------------------------------------
if text then
local lacasa1_Msg = database:get(bot_id.."lacasa1:Add:Filter:Rp2"..text..result.chat_id_)   
if lacasa1_Msg then
send(msg.chat_id_, msg.id_," ❈︙"..lacasa1_Msg)
