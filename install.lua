...
local RunBot = io.open("lacasa", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/lacasa
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr lacasa
wget "https://raw.githubusercontent.com/lacasaa/lacasa/master/lacasa.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./lacasa.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S lacasa -X kill
screen -S lacasa ./lacasa
done
]])
RunTs:close()
end
